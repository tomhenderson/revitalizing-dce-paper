...
Net-next-nuse, a semi architecture port of the Linux kernel based on LibOS, was chosen over LKL due to design restrictions imposed by it being an architecture level port of
