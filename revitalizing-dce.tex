...
compability.  Finally, a Docker-based environment was configured to ease the
installation and usage of DCE for ns-3, expanding the range of Linux
distributions suported.  The result of this project is a forthcoming
...
that the host operating system environment that DCE both emulates and exists
...
Finally, Section 6 covers our conclusions and directions for future work.
